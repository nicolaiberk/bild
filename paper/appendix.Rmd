...
## Modeling Exposure with STM in TWFE Model



# Difference-in-Differences Estimates

Treated Group: Bild Readers in first (and only pre-treatment) wave.
Control Group: Never-Readers of Bild.
...
fread(here('data/raw/gles/Panel/long_cleaned.csv')) %>% 
  ...
  ggplot(aes(x = date_clean, y = `1130_clean`, lty = !treat, col = !treat)) +
  geom_line() +
