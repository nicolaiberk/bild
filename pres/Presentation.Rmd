...
EffectPlot(multi = F, scaled = "raw", size = 2) +
  theme_xaringan()
...
EffectPlot(multi = T, scaled = T, size = 2) +
  theme_xaringan()
...
EffectByWavePlot("2880h_clean", size = 2) +
  theme_xaringan()
...
EffectByWavePlot(dv = "1210_clean", size = 2) +
  theme_xaringan()
...
EffectByWavePlot(dv = "430i_clean", size = 2) +
  theme_xaringan()
...
EffectByWavePlot(dv = "mip_mig", size = 2) +
  theme_xaringan()
