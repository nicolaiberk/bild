...
subtitle: "Presentation at the 2021 Annual Conference of the Political Studies Association of Ireland"
author: "Nicolai Berk$^*$"
...
- However, **news consumers discount bias and take cues from outlets**.
...
$\rightarrow$ **within-outlet changes** in content most likely cases to observe media effects.
...
- I draw on literature on 
  + the **value-expectancy** framework [@Ajzen2000].
  + and **emphasis framing** [@Leeper2020; @Nelson1997].
- Argues that issue attitudes are a product of **associated considerations**.
