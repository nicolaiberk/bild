...
png(filename = here('data/gles/Panel/vis/ReadersWaves_rel.png'))
...
png(filename = here('data/gles/Panel/vis/ReadersWaves_abs.png'))
plot(str_extract(bild_vars, '\\d'), 
     n_readers, 
     main = 'Number of Bild readers across waves',
     xlab = 'Wave', ylab = 'n', type = 'l',
...
grid.arrange(p1, p2) %>% 
  ggsave(filename = here("paper/vis/LTT_attitudes.png"),
         height = 10, width = 10)
